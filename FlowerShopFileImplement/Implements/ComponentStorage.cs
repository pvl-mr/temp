...
namespace FlowerShopFileImplement.Implements
{
    public class ComponentStorage : IComponentStorage
    {
        ...
        public void Insert(ComponentBindingModel model)
        {
            ...
            var element = new Componet { Id = maxId + 1 };
        ...
        {
            Componet element = source.Components.FirstOrDefault(rec => rec.Id == model.Id);
            if (element != null)
            {
        ...
        private Componet CreateModel(ComponentBindingModel model, Componet component)
        {
            component.ComponentName = model.ComponentName;
            return component;
        }
        private ComponentViewModel CreateModel(Componet component)
        {
